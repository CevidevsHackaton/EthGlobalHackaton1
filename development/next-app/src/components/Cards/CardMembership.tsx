...
const CardMembership = ({ color }: { color?: string }) => {
    ...
    <>
      <CardFrame>
        <div className="flex-none sm:flex">
          <div
            className={` mr-5 sm:mb-0 mb-3 hidden sm:grid sm:h-20 sm:w-20 sm:shrink-0 sm:place-content-center sm:rounded-full sm:border-2`}
